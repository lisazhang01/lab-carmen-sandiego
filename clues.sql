...
SELECT name, population FROM country WHERE region = 'Southern Europe' ORDER BY population LIMIT 1; # Holy See (vatican)
...
SELECT * FROM city WHERE name LIKE 'Ser%'; #Serra BRA
SELECT name, continent FROM country WHERE code = 'BRA'; #Brazil, South America
...
SELECT name FROM city WHERE id = '211'; #Brazilia
